        ...
        <div className="flex-none p-4 border-t border-green-900/20">
          ...
          <form onSubmit={handleSubmit} className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex-none w-11 h-11 rounded-xl btn-primary flex items-center justify-center disabled:opacity-40 disabled:cursor-not-allowed disabled:transform-none"
            >
